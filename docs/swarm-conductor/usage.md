...
| `grokCredits` | **Only if the Grok CLI / API printed a number.** Do not scrape the SuperGrok meter screenshot. Do not invent remaining weekly %. Effort label is the budget knob; credits are an after-the-fact receipt |
