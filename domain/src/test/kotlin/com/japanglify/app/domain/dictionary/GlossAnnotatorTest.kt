...
class GlossAnnotatorTest {
    ...
    fun formatsPartOfSpeechAndGloss() {
        ...
        assertEquals(listOf("n. paper"), result)
    }
    ...
    fun looksUpByBaseFormNotSurface() {
        ...
        assertEquals(listOf("v. to go"), result)
    }
    ...
    fun fallsBackToSurfaceWhenNoBaseForm() {
        ...
        val result = annotator.annotate(listOf(JapaneseAnalyzer.SurfaceReading("は", "ワ", baseForm = null)))
        assertEquals(listOf("part. topic marker"), result)
    }
    ...
    fun preservesOrderAndSizeAcrossMixedHits() {
        ...
        assertEquals(listOf("n. Japanese", null, "v. to do"), result)
    }
    ...
    fun noPartOfSpeechOmitsAbbreviationPrefix() {
        ...
        assertEquals(listOf("mystery"), result)
    }
}
